...
const int PIN_LID_SERVO = 8;     // The GPIO number of the pin where the lid opener servo is connected.
const int PIN_SWITCH_SERVO = 0;  // The GPIO number of the pin where the switch manipulator servo is connected.
